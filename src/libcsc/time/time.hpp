...
public:
  ...
  bool operator<(const Time &rhs) const { return seconds_ < rhs.getSeconds(); }
  ...
  bool operator!=(const Time &rhs) const { return *this < rhs || rhs < *this; }
  ...
  friend std::ostream &operator<<(std::ostream &os, const Time &t) {
    ...
    os << days << "d " << hours << "h " << minutes << "m " << remaining_seconds
       << "s";
    return os;
  }
};
